...
<body class="flex h-screen overflow-hidden text-slate-300">
    ...
    <aside class="w-64 bg-[#0d0f16] border-r border-[#1a1e2a] flex flex-col z-50">
        ...
        <div class="p-6 bg-[#08090d] border-t border-[#1a1e2a]">
            ...
            <div id="disk-details" class="text-[9px] font-bold mono text-slate-600 uppercase flex justify-between">
    ...
    <main class="flex-1 flex flex-col overflow-hidden relative">
        <header class="h-14 bg-[#0d0f16] border-b border-[#1a1e2a] flex items-center justify-between px-8">
            <div class="flex items-center gap-4">
                ...
                <span class="text-[12px] font-black uppercase tracking-widest text-white">v7.1 Hybrid Kernel | Creator: Exulizer</span>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                             ...
                             <div class="flex gap-2">
                                ...
                                <button onclick="pickFolder('config-source')" class="bg-white/5 p-2 rounded text-[10px] uppercase font-black transition-colors hover:bg-white/10">Pick</button>
                             </div>
                        </div>
                        <div>
